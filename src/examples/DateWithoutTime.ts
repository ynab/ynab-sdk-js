...
export class DateWithoutTime {
  ...
  public static createFromLocalDate(dateValue: Date): DateWithoutTime {
    var dateWithoutTime: DateWithoutTime = new DateWithoutTime(
  ...
  public static createFromISOString(stringValue: string): DateWithoutTime {
    ...
    return DateWithoutTime.createFromString(
      stringValue,
      DateWithoutTime.getISOStringFormat()
    );
  }

  public static createFromISOStringOrDateWithoutTime(
    value: DateWithoutTime | string
  ): DateWithoutTime {
  ...
  public static createFromString(
    ...
    if (!tempMoment.isValid()) throw new Error("Invalid date: " + stringValue);
  ...
  public static createFromISOStringOrDateWithOutTime(
    date: DateWithoutTime | string
  ): DateWithoutTime {
    let castDate: DateWithoutTime;
  ...
  public equalsByMonth(dateWithoutTimeToCompare: DateWithoutTime): boolean {
    return (
      this.getMonth() == dateWithoutTimeToCompare.getMonth() &&
      this.getYear() == dateWithoutTimeToCompare.getYear()
    );
  }

  public equalsDateWithoutTime(
    dateWithoutTimeToCompare: DateWithoutTime
  ): boolean {
    if (dateWithoutTimeToCompare == null) return false;
    return (
      this._internalUTCMoment.valueOf() ==
      dateWithoutTimeToCompare._internalUTCMoment.valueOf()
    );
  }

  public isAfter(dateWithoutTimeToCompare: DateWithoutTime): boolean {
    return this._internalUTCMoment.isAfter(
      dateWithoutTimeToCompare._internalUTCMoment
    );
  }

  public isBefore(dateWithoutTimeToCompare: DateWithoutTime): boolean {
    return this._internalUTCMoment.isBefore(
      dateWithoutTimeToCompare._internalUTCMoment
    );
  }
  ...
  public static latest(...dates: DateWithoutTime[]): DateWithoutTime {
    var latest: DateWithoutTime = null;
  ...
  // TODO: Combine equals methods
  // TODO: Add way to compare arrays of DWT using _.isEqualWith
}
