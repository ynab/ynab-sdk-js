 ...
 */
export function instanceOfSaveTransaction(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function SaveTransactionFromJSON(json: any): SaveTransaction {
    return SaveTransactionFromJSONTyped(json, false);
}

export function SaveTransactionFromJSONTyped(json: any, ignoreDiscriminator: boolean): SaveTransaction {
...
export function SaveTransactionToJSON(value?: SaveTransaction | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
