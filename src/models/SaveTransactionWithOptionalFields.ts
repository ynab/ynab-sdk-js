...
export function SaveTransactionWithOptionalFieldsToJSON(json: any): SaveTransactionWithOptionalFields {
    return SaveTransactionWithOptionalFieldsToJSONTyped(json, false);
}

export function SaveTransactionWithOptionalFieldsToJSONTyped(value?: SaveTransactionWithOptionalFields | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
