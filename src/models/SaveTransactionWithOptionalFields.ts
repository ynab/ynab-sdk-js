 ...
 * @export
 */
export const SaveTransactionWithOptionalFieldsClearedEnum = {
    Cleared: 'cleared',
    Uncleared: 'uncleared',
    Reconciled: 'reconciled'
} as const;
export type SaveTransactionWithOptionalFieldsClearedEnum = typeof SaveTransactionWithOptionalFieldsClearedEnum[keyof typeof SaveTransactionWithOptionalFieldsClearedEnum];

/**
 * @export
 */
export const SaveTransactionWithOptionalFieldsFlagColorEnum = {
    Red: 'red',
    Orange: 'orange',
    Yellow: 'yellow',
    Green: 'green',
...
export type SaveTransactionWithOptionalFieldsFlagColorEnum = typeof SaveTransactionWithOptionalFieldsFlagColorEnum[keyof typeof SaveTransactionWithOptionalFieldsFlagColorEnum];


/**
 * Check if a given object implements the SaveTransactionWithOptionalFields interface.
 */
export function instanceOfSaveTransactionWithOptionalFields(value: object): boolean {
    let isInstance = true;
