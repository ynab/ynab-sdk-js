 ...
 */
export function instanceOfCategoryGroupWithCategoriesAllOf(value: object): boolean {
    let isInstance = true;
...
export function CategoryGroupWithCategoriesAllOfFromJSON(json: any): CategoryGroupWithCategoriesAllOf {
    return CategoryGroupWithCategoriesAllOfFromJSONTyped(json, false);
}

export function CategoryGroupWithCategoriesAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): CategoryGroupWithCategoriesAllOf {
...
export function CategoryGroupWithCategoriesAllOfToJSON(value?: CategoryGroupWithCategoriesAllOf | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
