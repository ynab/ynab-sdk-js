 ...
 * @export
 */
export const CategoryBaseGoalTypeEnum = {
    Tb: 'TB',
    Tbd: 'TBD',
    Mf: 'MF',
    Need: 'NEED',
 ...
 */
export function instanceOfCategoryBase(value: object): value is CategoryBase {
...
export function CategoryBaseToJSON(json: any): CategoryBase {
    return CategoryBaseToJSONTyped(json, false);
}

export function CategoryBaseToJSONTyped(value?: CategoryBase | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
