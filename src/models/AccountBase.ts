 ...
 */
export function instanceOfAccountBase(value: object): value is AccountBase {
...
export function AccountBaseToJSON(json: any): AccountBase {
    return AccountBaseToJSONTyped(json, false);
}

export function AccountBaseToJSONTyped(value?: AccountBase | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
