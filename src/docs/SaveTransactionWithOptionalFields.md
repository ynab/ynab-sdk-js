...
```typescript
import type { SaveTransactionWithOptionalFields } from ''
...
} satisfies SaveTransactionWithOptionalFields
...
const exampleParsed = JSON.parse(exampleJSON) as SaveTransactionWithOptionalFields
