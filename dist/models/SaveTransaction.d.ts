 ...
 */
export declare function instanceOfSaveTransaction(value: object): boolean;
export declare function SaveTransactionFromJSON(json: any): SaveTransaction;
export declare function SaveTransactionFromJSONTyped(json: any, ignoreDiscriminator: boolean): SaveTransaction;
export declare function SaveTransactionToJSON(value?: SaveTransaction | null): any;
