...
import { MoneyMovementGroupsResponseFromJSON, MoneyMovementsResponseFromJSON, } from '../models/index';
/**
 *
 */
var MoneyMovementsApi = /** @class */ (function (_super) {
    __extends(MoneyMovementsApi, _super);
    function MoneyMovementsApi() {
     ...
     */
    MoneyMovementsApi.prototype.getMoneyMovementGroupsRaw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return MoneyMovementGroupsResponseFromJSON(jsonValue); })];
                }
            });
        });
    };
     ...
     */
    MoneyMovementsApi.prototype.getMoneyMovementGroupsByMonthRaw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, token, tokenString, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     */
    MoneyMovementsApi.prototype.getMoneyMovementsRaw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, token, tokenString, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return MoneyMovementsResponseFromJSON(jsonValue); })];
                }
            });
        });
    };
     ...
     */
    MoneyMovementsApi.prototype.getMoneyMovementsByMonthRaw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, token, tokenString, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
