...
import { BudgetDetailResponseFromJSON, BudgetSettingsResponseFromJSON, BudgetSummaryResponseFromJSON, } from '../models/index';
/**
 *
 */
var BudgetsApi = /** @class */ (function (_super) {
     ...
     * Single budget
     */
    BudgetsApi.prototype.getBudgetByIdRaw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return BudgetDetailResponseFromJSON(jsonValue); })];
                }
            });
        });
    };
     ...
     * Budget Settings
     */
    BudgetsApi.prototype.getBudgetSettingsByIdRaw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, token, tokenString, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return BudgetSettingsResponseFromJSON(jsonValue); })];
                }
            });
        });
    };
     ...
     * List budgets
     */
    BudgetsApi.prototype.getBudgetsRaw = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, token, tokenString, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return BudgetSummaryResponseFromJSON(jsonValue); })];
                }
            });
        });
    };
