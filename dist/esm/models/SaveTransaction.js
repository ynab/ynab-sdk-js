 ...
 */
export function instanceOfSaveTransaction(value) {
    var isInstance = true;
    return isInstance;
}
export function SaveTransactionFromJSON(json) {
    return SaveTransactionFromJSONTyped(json, false);
}
export function SaveTransactionFromJSONTyped(json, ignoreDiscriminator) {
...
export function SaveTransactionToJSON(value) {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
