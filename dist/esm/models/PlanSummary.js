 ...
 */
export function instanceOfPlanSummary(value) {
...
export function PlanSummaryFromJSON(json) {
    return PlanSummaryFromJSONTyped(json, false);
}
export function PlanSummaryFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PlanSummaryToJSON(json) {
    return PlanSummaryToJSONTyped(json, false);
}
export function PlanSummaryToJSONTyped(value, ignoreDiscriminator) {
