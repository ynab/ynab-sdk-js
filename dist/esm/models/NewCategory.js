 ...
 */
export function instanceOfNewCategory(value) {
    return true;
}
export function NewCategoryFromJSON(json) {
    return NewCategoryFromJSONTyped(json, false);
}
export function NewCategoryFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function NewCategoryToJSONTyped(value, ignoreDiscriminator) {
