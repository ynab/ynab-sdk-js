...
|                            | Method                                                                                                                                    | Description                                         |
|----------------------------|-------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------|
| **User**                   | [user.getUser()](blob/master/dist/api.d.ts#L3354)                                                                                            | Returns authenticated user information              |
| **Budgets**                | [budgets.getBudgets()](blob/master/dist/api.d.ts#L2428)                                                                                   | Returns budgets list with summary information       |
|                            | [budgets.getBudgetById(budget_id)](blob/master/dist/api.d.ts#L2411)                                                                       | Returns a single budget with all related entities   |
|                            | [budgets.getBudgetSettingsById(budget_id)](blob/master/dist/api.d.ts#L2420)                                                     | Returns settings for a budget                       |
| **Accounts**               | [accounts.getAccounts(budget_id)](blob/master/dist/api.d.ts#L2303)                                                                      | Returns all accounts                                |
|                            | [accounts.getAccountById(budget_id, account_id)](blob/master/dist/api.d.ts#L2294)                                                        | Returns a single account                            |
| **Categories**             | [categories.getCategories(budget_id)](blob/master/dist/api.d.ts#L2514)                                                              | Returns all categories grouped by category group.   |
|                            | [categories.getCategoryById(budget_id, category_id)](blob/master/dist/api.d.ts#L2524)                                                  | Returns a single category                           |
| **Payees**                 | [payees.getPayees(budget_id)](blob/master/dist/api.d.ts#L2849)                                                                              | Returns all payees                                  |
|                            | [payees.getPayeeById(budget_id, payee_id)](blob/master/dist/api.d.ts#L2840)                                                                | Returns single payee                                |
| **Payee Locations**        | [payee_locations.getPayeeLocations(budget_id)](blob/master/dist/api.d.ts#L2743)                                           | Returns all payee locations                         |
|                            | [payee_locations.getPayeeLocationById(budget_id, payee_location_id)](blob/master/dist/api.d.ts#L2734)                             | Returns a single payee location                     |
|                            | [payee_locations.getPayeeLocationsByPayee(budget_id, payee_id)](blob/master/dist/api.d.ts#L2753)                     | Returns all payee locations for the specified payee |
| **Months**                 | [months.getBudgetMonths(budget_id)](blob/master/dist/api.d.ts#L2620)                                                                | Returns all budget months                           |
|                            | [months.getBudgetMonth(budget_id, month)](blob/master/dist/api.d.ts#L2611)                                                           | Returns a single budget month                       |
| **Transactions**           | [transactions.getTransactions(budget_id)](blob/master/dist/api.d.ts#L3252)                                                      | Returns budget transactions                         |
|                            | [transactions.getTransactionsByAccount(budget_id, account_id)](blob/master/dist/api.d.ts#L3264)                            | Returns all transactions for a specified account    |
|                            | [transactions.getTransactionsByCategory(budget_id, category_id)](blob/master/dist/api.d.ts#L3276)                          | Returns all transactions for a specified category   |
|                            | [transactions.getTransactionById(budget_id, transaction_id)](blob/master/dist/api.d.ts#L3241)                                      | Returns a single transaction                        |
|                            | [transactions.updateTransaction(budget_id, transaction_id, transaction)](blob/master/dist/api.d.ts#L3299)                                 | Updates a transaction                               |
|                            | [transactions.createTransaction(budget_id, transaction)](blob/master/dist/api.d.ts#L3231)                                     | Creates a new transaction                           |
|                            | [transactions.bulkCreateTransactions(budget_id, transactions)](blob/master/dist/api.d.ts#L3221)                        | Creates multiple transactions                       |
| **Scheduled Transactions** | [scheduled_transactions.getScheduledTransactions(budget_id)](blob/master/dist/api.d.ts#L2945)               | Returns all scheduled transactions                  |
|                            | [scheduled_transactions.getScheduledTransactionById(budget_id, scheduled_transaction_id)](blob/master/dist/api.d.ts#L2936) | Returns a single scheduled transaction              |
                                                                |
