...
|                            | [transactions.updateTransaction(budget_id, transaction_id, transaction)](https://github.com/ynab/ynab-sdk-js/blob/master/dist/api.d.ts)                  | Updates a transaction                                 |
|                            | [transactions.createTransaction(budget_id, save_transactions)](https://github.com/ynab/ynab-sdk-js/blob/master/dist/api.d.ts)                            | Creates one transactions                  |
|                            | [transactions.createTransactions(budget_id, save_transactions)](https://github.com/ynab/ynab-sdk-js/blob/master/dist/api.d.ts)                            | Creates multiple transactions                  |
|                            | [transactions.bulkCreateTransactions(budget_id, transactions)](https://github.com/ynab/ynab-sdk-js/blob/master/dist/api.d.ts)                            | Creates multiple transactions                         |
