...
|                            | [transactions.getTransactionsByType(budget_id, type)](https://github.com/ynab/ynab-sdk-js/blob/master/dist/api.d.ts)                                      | Returns all transactions of a specified type ("unapproved" or "uncategoried")     |
